...
<center><h2>Add Album Type</h2></center>

<div class="container">
<form name="form"  action="./AddAlbumTypeController" method="POST">
    <div class="row">
    	<div class="col-25">
        	<label for="fname">Album Type Name</label>
      	</div>
        <div class="col-75">
        	<input type="text" placeholder="Album Type Name" value="${editaldumtype.type_name}" name="type_name" required>
      	</div>
    </div>
    <div class="row">
    	<div class="col-25">
      	...
      	<div class="col-75">
        	<input type="text" placeholder="Description" value="${editaldumtype.type_description}" name="type_description" required>
        	<input type= "hidden" value="${editaldumtype.type_id}" name="type_id" >
      	</div>
    </div> 
    <div class="row">
      	<div class="col-25">
...
<%
	...
	if(logAndAuditDAO.save("Admin Added Album Type", "Admin", email)) {
		System.out.println("Add album type event inserted");
	}
%>
</body>
</html>
