...
<center ><h3 style="margin-top:-40px;">We have sent a verification code to your respective email.</h3><br><p style="margin-top:-20px;"> Please type the code to get verified</p></center>
<form class='login-form' name="form" action="forgotPasswordController" method="POST">
  <div class="flex-row">
