...
<%
	...
	//If user is already logged in redirect it to Home Page.
	if(email!=null){
	...
	if(status!=null){
		if(status.equals("false")){
			...
			out.print("Something is wrong! Please try again");
		}
	}
...
<form class='login-form' action="Loginprocess" method="POST">
  <div class="flex-row">
    ...
    <input id="email" class='lf--input' placeholder='Email' type='email' name="email">
  </div>
  <div class="flex-row">
...
<br>
<a class='lf--forgot' href='CollectEmail.jsp'>Forgot password?</a><br>
<a class='lf--forgot' href='AdminRegister.jsp'>New User?</a>
