		...
		<div class="table-wrapper">
			<div class="table-title" style="background-color: black;">
				<div class="row">
					...
					<div class="col-sm-6">
					<button class="btn btn-primary" onclick="window.location.href='./UploadTrackController?action=save'">Add New Track</button>
					</div>
				</div>
			</div>
			<table class="table table-striped table-hover" id= "table-id">
				...
				<tbody>
<c:forEach  items="${trlist}" var="track">
					<tr>
						...
						<a href="${pageContext.request.contextPath}/TrackViewerController?action=EDIT&id=${track.track_id}"><i class="material-icons" style="color:#FFC133;">&#xE254;</i></a>
  						<a href="${pageContext.request.contextPath}/TrackViewerController?action=DELETE&id=${track.track_id}"><i class="material-icons" style="color:red;">&#xE872;</i></a> 
...
<%
	...
	if(logAndAuditDAO.save("Retrieve Tracks", "Admin", email)) {
		System.out.println("Retrieve Tracks event inserted");
	}
%>
</body>
</html>
