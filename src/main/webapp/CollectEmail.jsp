...
<form  action="SendMailFPController" method="post">
<input type="email" name="email">
<input type="submit" value="verify">
</form>

</div> -->
<center><h4 style="margin-top:-60px;">Please enter Email</h4></center>
<form class='login-form' name="form" action = "SendMailFPController" method="POST">
  <div class="flex-row">
    ...
    <input id="email" class='lf--input' placeholder='Email' type='email' name="email" required>
  </div>
