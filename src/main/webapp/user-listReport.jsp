			...
			<table class="table table-striped table-hover" id= "table-id">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="${pageContext.request.contextPath}/UserController?action=DELETE&email=${user.email}" style="color: #F44336;"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>						
						</td>
					</tr>
					</c:forEach>
...
<%
	...
	if(logAndAuditDAO.save("Retrieve User Data", "Admin", email)) {
		System.out.println("Retrieve User Data event inserted");
	}
%>
</body>
</html>
